    ...
    return (
        <div>
            ...
            <div className="flex justify-center px-24 gap-24 pb-24 items-center sm:text-center md:text-left lg:text-left text-center sm:flex-col md:flex-row lg:flex-row flex-col">
                ...
                <img className=" min-w-[85vw] sm:min-w-[400px] sm:max-w-[400px] sm:min-h-[100px] sm:max-h[100px] md:min-w-[400px] md:max-w-[400px] md:min-h-[100px] md:max-h[100px] lg:min-w-[600px] lg:max-w-[600px] lg:min-h-[300px] lg:max-h[300px] rounded-xl border-8 border-white" src={'/letter.png'}></img>
            </div>
        </div>
    );
}
