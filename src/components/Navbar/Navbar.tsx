...
export const Navbar: React.FC<NavbarProps> = ({ handleScroll, refs }) => {
      ...
      sections.forEach((section) => {
        ...
        if (section.ref) {
          ...
          if (rect.bottom > 0 && rect.top < window.innerHeight) {
            // checks if the section ref intersects with the viewport window
  ...
  return (
    <div className={styles.navbar}>
      ...
      >
        <div className="bg-notionHover rounded-full hidden lg:block md:block sm:block border border-notionBorder">
